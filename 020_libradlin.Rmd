...
Περισσότερα και πιο πρόσφατα αρχεία μπορούν να βρεθούν εδώ: [github.com/thanasisn/IStillBreakStuff/tree/main/libradtran](https://github.com/thanasisn/IStillBreakStuff/tree/main/libradtran)
...
Παραλληλοποίηση με τη χρήση subshells στο background και της εντολής `wait`.
--------------------------------------------------------------------------------
...
Με το `parallel` (`GNU parallel`) μπορούμε να χρησιμοποιήσουμε πολλαπλούς πυρήνες ενός υπολογιστή, αλλά και περισσότερους από έναν υπολογιστή (cluster). Το `parallel` είναι στην ουσία ένας διαχειριστής εκτελέσεων (job scheduler). Τα επόμενα παραδείγματα είναι ίσως η πιο απλοποιημένη παραμετροποίση που μπρορούμε να κάνουμε. Για πιο σύνθετες περιπτώσεις δείτε τα εγχειρίδια των προγραμμάτων.
